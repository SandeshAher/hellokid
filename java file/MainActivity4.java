    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v1path = "android.resource://" + getPackageName() + "/" + R.raw.circulatory;
        ...
        v22.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v2path = "android.resource://" + getPackageName() + "/" + R.raw.digestive;
        ...
        v33.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                v3path = "android.resource://" + getPackageName() + "/" + R.raw.respiratory;
